/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 49cb590f4ced1829dafdadfaea9405d3)
...
declare namespace Cloudflare {
  ...
  interface DevEnv {
    ...
    EMAIL: SendEmail;
    AI: Ai;
    API_PUBLIC_HOST: "http://localhost:8787";
    WEB_PUBLIC_HOST: "http://localhost:5173";
    ...
    PLATFORM_LLM_SPEC: string;
    PLATFORM_LLM_BASE_URL: string;
    PLATFORM_LLM_MODEL: string;
    REVENUECAT_PROJECT_ID: string;
    REVENUECAT_ENTITLEMENT_PERSONAL: string;
    REVENUECAT_ENTITLEMENT_PRO: string;
    REVENUECAT_ENTITLEMENT_BYOK: string;
    ChatAgent: DurableObjectNamespace<import("./src/index").ChatAgent>;
    BINDER: DurableObjectNamespace<import("./src/index").BinderDO>;
    DOCUMENT: DurableObjectNamespace<import("./src/index").DocumentDO>;
    EPUB_PROCESSOR: Workflow<Parameters<import("./src/index").EpubWorkflow["run"]>[0]["payload"]>;
    DELETE_DOCUMENT: Workflow<
      Parameters<import("./src/index").DocumentDeletionWorkflow["run"]>[0]["payload"]
    >;
    DELETE_USER: Workflow<
      Parameters<import("./src/index").AccountDeletionWorkflow["run"]>[0]["payload"]
    >;
  }
  ...
  interface Env {
    ...
    EMAIL?: SendEmail;
    AI?: Ai;
    API_PUBLIC_HOST?: "http://localhost:8787" | "https://api.baindar.com";
    WEB_PUBLIC_HOST?: "http://localhost:5173" | "https://baindar.com";
